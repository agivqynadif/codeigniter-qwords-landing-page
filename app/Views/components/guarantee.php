<div class="container-fluid mt-5" style="background-color: #EEE7DA;">
    <div class="container-fluid text-center py-3" style="height: 500px;">
        <div class="row py-5">
            <div class="col">
                <a href="">
                    <img src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/illustrations/guarantee.webp" class="img-fluid">
                </a>
            </div>
